...
module.exports = function(config) {
  config.set({
    ...
    files: [
      '../../source/client/js/vendor/jquery-2.0.3.min.js',
      '../../source/client/js/vendor/angular.js',
      '../../source/client/js/vendor/angular-cookies.js',
      '../../source/client/js/vendor/angular-ui-router.js',
      '../../source/client/js/vendor/angular-mocks.js',
      '../../source/client/js/services.js',
      '../../source/client/js/controllers.js',
      '../../source/client/js/metrics.js',
